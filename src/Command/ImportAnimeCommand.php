...
class ImportAnimeCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($animeMalIds as $animeMalId) {
            ...
            if (!$mainPicture = $animeRegistered->getMainPicture()) {
                $mainPicture = new MainPicture();
            }
            $mainPicture->setMedium($animeDetailsContent['main_picture']['medium'] ?? null);
            $mainPicture->setLarge($animeDetailsContent['main_picture']['large'] ?? null);
